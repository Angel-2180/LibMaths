...
namespace lm
{
    ...
    public:
        ...
        */
        FQuat(float x, float y, float z, float w = 0.f);
        ...
        */
        ...
        static FQuat FromEuler(const FVec3& euler);

        static FQuat FromEuler(float roll, float pitch, float yaw);
         ...
         *
        */
        static FMat3 ToRotateMat3(FQuat const& q);
        /**
